    ...
    <section aria-labelledby="porter-services-heading" className="px-5 pb-20 sm:px-8 sm:pb-28">
      <div className="mx-auto grid max-w-7xl gap-8 rounded-[2rem] bg-[#143d1a] p-8 text-white sm:p-12 lg:grid-cols-[1fr_auto] lg:items-center">
        <div>
          ...
          <p className="mt-5 max-w-3xl leading-7 text-white/70">Recurring Porter Services combine scheduled property upkeep with visual property condition checks, photo documentation, and maintenance and safety issue reporting to keep management informed.</p>
        </div>
