...
function item(id: string, type: AttentionItem["type"], severity: AttentionItem["severity"], category: AttentionItem["category"], title: string, description: string, record_type: string, record_id: string, client_id: string | null, entity_label: string | null, due_date: string | null, scheduled_date: string | null, created_at: string, action_url: string, action_label: string, communication_context: CommunicationComposerContext | null = null): AttentionItem { return { id, type, severity, category, title, description, record_type, record_id, client_id, entity_label, due_date, scheduled_date, created_at, action_url, action_label, metadata: {}, snoozable: true, dismissible: true, attention_state: null, communication_context }; }
