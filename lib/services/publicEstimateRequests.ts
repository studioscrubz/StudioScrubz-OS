...
function allowedFrequency(value:Frequency,service:CatalogService):Frequency{const allowed:Frequency[]=service.is_recurring_available?["One-Time","Daily","Weekly","Biweekly","Twice Monthly","Monthly"]:["One-Time"];if(!allowed.includes(value))throw new PublicEstimateRequestError("The selected frequency is unavailable for this service.");return value}
