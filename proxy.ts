...
export async function proxy(request: NextRequest) {
  ...
  if (hostname === "studioscrubz.com") {
    ...
    const marketingPaths = new Set(["/", "/residential", "/commercial", "/property-management", "/property-porter-services", "/airbnb-cleaning", "/post-construction", "/pressure-washing", "/about", "/contact"]);
