...
export interface Database {
  public: {
    Tables: {
      ...
      mileage_stops:{Row:MileageStop;Insert:Omit<MileageStop,"id"|"created_at"|"updated_at">&{id?:string;created_at?:string;updated_at?:string};Update:Partial<Pick<MileageStop,"stop_order"|"job_id"|"property_id"|"address"|"label"|"updated_at">>;Relationships:[{foreignKeyName:"mileage_stops_mileage_entry_id_fkey";columns:["mileage_entry_id"];isOneToOne:false;referencedRelation:"mileage_entries";referencedColumns:["id"]},{foreignKeyName:"mileage_stops_job_id_fkey";columns:["job_id"];isOneToOne:false;referencedRelation:"jobs";referencedColumns:["id"]},{foreignKeyName:"mileage_stops_property_id_fkey";columns:["property_id"];isOneToOne:false;referencedRelation:"properties";referencedColumns:["id"]}]};
