...
export type AssessmentMethod = "On-Site Walkthrough" | "Customer Photo Submission" | "In-Person Walkthrough";
export const ASSESSMENT_SALES_STAGES = ["New", "Qualification", "Contacting", "Assessment Method Required", "Walkthrough Scheduled", "Awaiting Customer Photos", "Assessment In Progress", "Pricing Review", "Proposal Ready", "Proposal Created", "Closed / Not Proceeding"] as const;
export type AssessmentSalesStage = (typeof ASSESSMENT_SALES_STAGES)[number];
export type PostConstructionAssessment = {
  projectType: "" | "New Construction" | "Renovation / Remodel" | "Tenant Improvement" | "Restoration" | "Other";
  propertyUse: "" | "Residential" | "Commercial";
  projectPhase: "" | "Planning" | "Active Construction" | "Punch List" | "Substantially Complete" | "Ready for Cleaning";
  ...
  utilities: { water: boolean; electricity: boolean; restroom: boolean };
  decisionMakerStatus: "" | "Decision Maker" | "Influencer" | "Awaiting Decision Maker" | "Unknown";
  contactStatus: "" | "Not Contacted" | "Attempting Contact" | "Contacted" | "Qualified" | "Not Qualified";
