...
export type MileageWithRelations=MileageEntry&{vehicle:Vehicle;employee:Employee|null;crew:Crew|null;job:Job|null;client:Client|null;property:Property|null};
