...
export type MileageStop={id:string;mileage_entry_id:string;stop_order:number;job_id:string|null;property_id:string|null;address:string;label:string|null;created_at:string;updated_at:string};
export type MileageStopInput=Pick<MileageStop,"job_id"|"property_id"|"address"|"label">;
