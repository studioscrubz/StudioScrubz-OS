...
export const JOB_STATUSES = ["Ready to Schedule", "Scheduled", "Crew Assigned", "In Progress", "Completed", "Cancelled", "Archived"] as const;
export type JobStatus = (typeof JOB_STATUSES)[number];
export type JobAssignedTeam = string[];
export type JobChecklistItem = { id: string; label: string; completed: boolean };
export type JobPhoto = { id: string; fileName: string; storagePath: string | null };
