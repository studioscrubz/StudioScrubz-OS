...
export type Invoice = {
  id:string; invoice_number:string; job_id:string; proposal_id:string|null; client_id:string; property_id:string;
...
export type InvoiceWithRelations = Invoice & { job:JobWithRelations; proposal:Proposal|null; client:Client; property:Property };
