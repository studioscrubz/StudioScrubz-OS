...
export type InvoiceJobLine = {
  id:string; invoice_id:string; job_id:string; property_id:string|null;
  job_number_snapshot:string; property_name_snapshot:string|null;
  property_address_snapshot:string; service_name_snapshot:string;
  service_date_snapshot:string; amount:number; created_at:string;
};
export type ContractorInvoiceEligibleJob = {
  id:string; job_number:string; property_id:string; property_name:string;
  property_address:string; service_name:string; service_date:string; amount:number;
};
export type Invoice = {
  ...
  is_consolidated:boolean; job_lines:InvoiceJobLine[];
