...
export type AddonPricingType = "Flat Price" | "Per Unit";
export type CatalogAddonSnapshot = { id:string; catalogAddonId:string; name:string; description:string|null; price:number; pricingModel:ServicePricingModel; unitLabel:string|null; pricingType?:AddonPricingType; quantity?:number; unitName?:string|null; unitPrice?:number; lineTotal?:number };
export type ServiceAddonInput = Omit<ServiceAddon,"id"|"created_at"|"updated_at"|"archived_at">;
export type RecurringPricingRule = { id:string; rule_name:string|null; normalized_rule_name:string|null; service_id:string|null; frequency:string; adjustment_type:RecurringAdjustmentType; adjustment_value:number; is_active:boolean; created_at:string; updated_at:string };
export type RecurringPricingRuleInput = Omit<RecurringPricingRule,"id"|"normalized_rule_name"|"created_at"|"updated_at">;
