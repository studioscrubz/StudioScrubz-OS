...
export function clientDisplayName(client: Client): string { const contact = [client.first_name, client.last_name].filter(Boolean).join(" "); return client.client_type === "Commercial" ? client.company_name || contact || "Unnamed client" : contact || client.company_name || "Unnamed client"; }
