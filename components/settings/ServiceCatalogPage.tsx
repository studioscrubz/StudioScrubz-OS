...
type FormField = { key: string; label: string; type?: "text" | "number" | "checkbox"; options?: readonly { label: string; value: string }[] };
...
function formFields(kind: Tab, services: CatalogService[]): FormField[] {
  ...
  if (kind === "Services") return [{ key: "service_name", label: "Service Name" }, { key: "service_code", label: "Service Code" }, { key: "division", label: "Division", options: options(SERVICE_DIVISIONS) }, { key: "category", label: "Category" }, { key: "description", label: "Description" }, { key: "pricing_model", label: "Pricing Model", options: options(SERVICE_PRICING_MODELS) }, { key: "base_price", label: "Base Price", type: "number" }, { key: "minimum_price", label: "Minimum Price", type: "number" }, { key: "unit_label", label: "Unit Label" }, { key: "display_order", label: "Display Order", type: "number" }, { key: "is_recurring_available", label: "Recurring Available", type: "checkbox" }, { key: "is_active", label: "Active", type: "checkbox" }, { key: "notes", label: "Notes" }];
