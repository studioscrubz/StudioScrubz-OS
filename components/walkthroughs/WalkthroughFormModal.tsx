...
export function WalkthroughFormModal({ walkthrough, initialEstimate, onClose, onSaved, onViewDuplicate }: Props) {
  ...
  async function save(nextStatus?: WalkthroughStatus) {
    ...
    if ((measurements.assessmentMethod??"In-Person Walkthrough")==="In-Person Walkthrough"&&(!date || !time)) return setError("In-person walkthrough date and time are required.");
