...
export function PhotoGallery({ photos, remove, saveCaption, readonly = false, canDelete = true }: { photos: OperationalPhotoWithUrl[]; remove?: (photo: OperationalPhotoWithUrl) => void; saveCaption?: (photo: OperationalPhotoWithUrl, caption: string) => void; readonly?: boolean; canDelete?: boolean }) {
