...
export function PhotoCaptureQueue({ photos, setPhotos, categories, busy = false, upload }: { photos: PendingOperationalPhoto[]; setPhotos: (photos: PendingOperationalPhoto[]) => void; categories: readonly OperationalPhotoCategory[]; busy?: boolean; upload?: () => void }) {
