...
export const services = [
  ...
  { title: "Airbnb / Turnover Cleaning", description: "Consistent turnover support designed around presentation, timing, and guest-ready details. Each plan is coordinated around the property and its confirmed turnover needs.", href: "/airbnb-cleaning" },
  { title: "Property Management / Unit Turns", description: "Flexible cleaning for vacant units, leasing spaces, common areas, and portfolio-wide property needs. Explore unit turns, shared-space cleaning, and recurring Property Porter Services.", href: "/property-management" },
