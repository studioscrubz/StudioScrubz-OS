...
export const services = [
  ...
  { title: "Property Management / Unit Turns", description: "Flexible cleaning for vacant units, leasing spaces, common areas, and portfolio-wide property needs. Service may include unit turns and shared spaces where applicable.", href: "/property-management" },
